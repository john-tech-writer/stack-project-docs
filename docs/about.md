...
The documents in this repository provide a methodology and structure for how-to documentation projects which are expected to extend over multiple years and volumes.
Skeletons are provided for a set of project docs for a documentation media stack, encompassing:
